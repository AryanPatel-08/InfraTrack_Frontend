...
const ProgressList = () => {
    ...
    const fetchData = async () => {
        try {
            const res = await axios.get("http://localhost:5178/api/Progresses");
            let processedData = [];
            if (res.data) {
    ...
    const handleSort = (field) => {
        ...
        const sorted = [...progressRecords].sort((a, b) => {
            let aVal = getValue(a, field);
            let bVal = getValue(b, field);
        ...
        <div className="progress-wrapper">
            ...
            <div className="progress-content">
                ...
                <div className="filter-section">
                    ...
                    <button className="add-progress-btn" onClick={() => navigate("/ProgressForm")}>
                        + Start New Project Progress
                    </button>
                </div>
